...
class ParsnipsSearcher:
    ...
    def __init__(self, parsnips_cli_version: str, swhid_context_qualifiers:SwhidContextQualifiers | None = None, repo_root=None, use_unicode=False, use_regex=False, strict=False):
        self.parsnips_cli_verison = parsnips_cli_version
    ...
    #                         node_swhid: str = str(ParsnipsContentSwhid.from_string(metadata_str))
